...
erDiagram
    USER ||--o{ GARDENPLOT : owns
    USER ||--o{ PLANTLOG : records
    USER ||--o{ WISHLIST : keeps
    USER ||--o{ TODOITEM : manages

    PLANT ||--o{ PLANTLOG : logged_in
    PLANT ||--o{ WISHLIST : wishlisted_in
    PLANT ||--o{ TODOITEM : referenced_by

    GARDENPLOT ||--o{ PLANTLOG : contains
    GARDENPLOT ||--o{ TODOITEM : used_by

    USER ||--o{ PLANT : suggested_plants
    ...
    GARDENPLOT {
      ...
      text description
      datetime created_on
      string unique_owner_name "unique_together(owner, name)"
    }
    ...
    WISHLIST {
      ...
      text notes
      datetime created_on
      string unique_owner_plant "unique_together(owner, plant)"
    }
